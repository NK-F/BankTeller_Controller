...
public class AccountDatabase {
    ...
    public String print() {
        String paragraphP = "";
        for (int i = 0; i < numAcct; i++) {
            paragraphP += accounts[i].toString() +"\n";
        }
        return paragraphP;
    }
    ...
    public String printByAccountType() {
        ...
        for (int i = 0; i < numAcct; i++) {
            paragraphPAT += arrayToSort[i].toString() + "\n";
        }
    ...
    public String printFeeAndInterest() {
        String paragraphFI = "";
        for (int i = 0; i < numAcct; i++) {
            paragraphFI += accounts[i] + "::fee $" + accounts[i].fee() + "::monthly interest $" + accounts[i].monthlyInterest() +"\n";
        }
        return paragraphFI;
    }
